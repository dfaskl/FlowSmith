...
将Spring AI 1.1.2集成到FlowSmith项目中，重构现有的LLM通信方式，减少重复代码，支持流式输出。
...
**路径**: `backend/src/main/java/com/flowsmith/engine/llm/PromptTemplateService.java`
...
**路径**: `backend/src/main/java/com/flowsmith/engine/llm/ChatClientFactory.java`
...
**路径**: `backend/src/main/java/com/flowsmith/engine/executor/impl/AbstractLLMNodeExecutor.java`
...
1. `backend/src/main/java/com/flowsmith/engine/llm/ChatClientFactory.java`
2. `backend/src/main/java/com/flowsmith/engine/llm/PromptTemplateService.java`
3. `backend/src/main/java/com/flowsmith/engine/llm/LLMNodeConfig.java` (配置DTO)
4. `backend/src/main/java/com/flowsmith/engine/executor/impl/AbstractLLMNodeExecutor.java`

### 修改文件 (4个)

1. `backend/pom.xml` - 添加Spring AI依赖
2. `backend/src/main/java/com/flowsmith/engine/executor/impl/OpenAINodeExecutor.java` - 继承基类
3. `backend/src/main/java/com/flowsmith/engine/executor/impl/DeepSeekNodeExecutor.java` - 继承基类
4. `backend/src/main/java/com/flowsmith/engine/executor/impl/QwenNodeExecutor.java` - 继承基类
